...
$(document).on("submit","#addCourseFrm" , function(){
  $.post("model/addCourseExe.php", $(this).serialize() , function(data){
  	if(data.res == "exist")
  	{
  		Swal.fire(
  			'Already Exist',
...
$(document).on("submit","#updateCourseFrm" , function(){
  $.post("model/updateCourseExe.php", $(this).serialize() , function(data){
     if(data.res == "success")
     {
        Swal.fire(
            'Success',
...
$(document).on("submit","#addExamFrm" , function(){
  $.post("model/addExamExe.php", $(this).serialize() , function(data){
...
$(document).on("submit","#updateExamFrm" , function(){
  $.post("model/updateExamExe.php", $(this).serialize() , function(data){
    if(data.res == "success")
    {
      Swal.fire(
          'Update Successfully',
...
$(document).on("submit","#updateQuestionFrm" , function(){
  $.post("model/updateQuestionExe.php", $(this).serialize() , function(data){
     if(data.res == "success")
     {
        Swal.fire(
            'Success',
...
$(document).on("click", "#deleteQuestion", function(e){
    ...
    var id = $(this).data("id");
     $.ajax({
      type : "post",
      url : "model/deleteQuestionExe.php",
      dataType : "json",  
      data : {id:id},
      cache : false,
      success : function(data){
...
$(document).on("submit","#addQuestionFrm" , function(){
  $.post("model/addQuestionExe.php", $(this).serialize() , function(data){
    if(data.res == "exist")
    {
      Swal.fire(
          'Already Exist',
...
$(document).on("submit","#addExamineeFrm" , function(){
  $.post("model/addExamineeExe.php", $(this).serialize() , function(data){
...
$(document).on("submit","#updateExamineeFrm" , function(){
  $.post("../../model/updateExamineeExe.php", $(this).serialize() , function(data){
     if(data.res == "success")
     {
        Swal.fire(
            'Success',
