        ...
        <div class="app-main__inner">
            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-header">DANH SÁCH KÌ THI
                    </div>
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                            <thead>
                            <tr>
                                <th class="text-left pl-4">Tên kì thi</th>
                            ...
                            <tbody>
                              <?php 
                                    ...
                                    while ($selExamRow = $selExam->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                             <a href="manage-exam.php?id=<?php echo $selExamRow['ex_id']; ?>" type="button" class="btn btn-primary btn-sm">Quản lý</a>
                                ...
                                { ?>
                                    <tr>
                                      <td colspan="5">
                                        <h3 class="p-3">Không có kì thi nào</h3>
                                      </td>
                                    </tr>
                                <?php }
                               ?>
