    ...
    <div class="app-main__inner">
        ...
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-header">Danh sách khoá học
                </div>
                <div class="table-responsive">
                    <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                        <thead>
                            <tr>
                                <th class="text-left pl-4">Tên</th>
                        ...
                        <tbody>
                            ...
                            if ($selCourse->rowCount() > 0) {
                                while ($selCourseRow = $selCourse->fetch(PDO::FETCH_ASSOC)) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button type="button" id="deleteCourse" data-id='<?php echo $selCourseRow['cou_id']; ?>' class="btn btn-danger btn-sm">Xoá</button>
                                        </td>
                                    </tr>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <h3 class="p-3" Không có khoá học nào!</h3>
                                    </td>
                                </tr>
                            <?php }
                            ?>
