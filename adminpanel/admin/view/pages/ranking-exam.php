  ...
  <div class="app-main__inner">
      ...
      <div class="app-page-title">
        <div class="page-title-wrapper">
          <div class="page-title-heading">
            <div><b class="text-primary">Xếp hạng theo kỳ thi</b><br>
              Tên kì thi : <?php echo $selEx['ex_title']; ?><br><br>
    ...
    <?php
      ...
      <div class="app-page-title">
        <div class="page-title-wrapper">
          <div class="page-title-heading">
            <div><b>XẾP HẠNG THEO KỲ THI</b></div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="main-card mb-3 card">
          <div class="card-header">Danh sách kỳ thi
          </div>
          <div class="table-responsive">
            <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
              <thead>
                <tr>
                  <th class="text-left pl-4">Tên kỳ thi</th>
                  <th class="text-left ">Khoá học</th>
                  <th class="text-left ">Mô tả</th>
                  <th class="text-center" width="8%">Kết quả</th>
                </tr>
              </thead>
              <tbody>
                <?php
                ...
                if ($selExam->rowCount() > 0) {
                  while ($selExamRow = $selExam->fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="?page=ranking-exam&exam_id=<?php echo $selExamRow['ex_id']; ?>" class="btn btn-success btn-sm">Xem</a>
                      </td>
                    </tr>
                  ...
                  <tr>
                    <td colspan="5">
                      <h3 class="p-3">Không tìm thấy!</h3>
                    </td>
                  </tr>
                <?php }
                ?>
